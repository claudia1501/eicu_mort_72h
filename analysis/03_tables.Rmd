...
table1_base %>%
   ...
   kable_classic_2(full_width = F, html_font = "Cambria") %>%
   add_header_above(c("", "", "No", "Yes", "", "")) %>%
   save_kable("C:/Users/cjimenez10J/Documents/projects/eicu_mort_72h/figures/table1_base.jpg", zoom = 10)
```
