...
dfs_to_join <- list(basic_demographics, labs_first_day, clearance_vitals_first, icu_mortality_72hrs,apachescore, apacheadmission, prev_dept_los, clearance_pivoted_lab, clearance_pivoted_med)
