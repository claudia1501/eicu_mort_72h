...
clearance_vitals_first <- run_query(getSQL("sql/clearance_vitals_first.sql"))
```
# Joining dataframes

```{r}
# Define the data frames to join
dfs_to_join <- list(basic_demographics, pivoted_med_first_day, labs_first_day, clearance_vitals_first, icu_mortality_72hrs,apachescore, apacheadmission, prev_dept_los)
