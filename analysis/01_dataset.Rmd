...
dfs_to_join <- list(basic_demographics, pivoted_med_first_day, labs_first_day, vitals_first_day, icu_mortality_72hrs)
...
final_df_order <- final_df_order %>%
  mutate_at(
    vars(
      norepinephrine_mean:norepinephrine_min,
      epinephrine_mean:epinephrine_min,
      dopamine_mean:dopamine_min,
      dobutamine_mean:dobutamine_min,
      phenylephrine_mean:phenylephrine_min,
      vasopressin_mean:vasopressin_min,
      milrinone_mean:milrinone_min,
      heparin_mean:heparin_min,
      warfarin_mean:warfarin_min
    ),
    ~ coalesce(., 0)
  )
...
final_df_order <- final_df_order %>%
  mutate_at(
    vars(
      aniongap_min,aniongap_max,albumin_min,albumin_max,bands_min,bands_max,bicarbonate_min,bicarbonate_max,hco3_min,hco3_max,bilirubin_min,bilirubin_max,creatinine_min,creatinine_max,chloride_min,chloride_max,glucose_min,glucose_max,hematocrit_min,hematocrit_max,hemoglobin_min,hemoglobin_max,lactate_min,lactate_max,platelet_min,platelet_max,potassium_min,potassium_max,ptt_min,ptt_max,inr_min,inr_max,pt_min,pt_max,sodium_min,sodium_max,bun_min,bun_max,wbc_min,wbc_max), ~ coalesce(., 0))
```
