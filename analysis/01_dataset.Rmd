...
er_los <- run_query(getSQL("sql/er_los.sql"))
```
# Joining dataframes

```{r}
# Define the data frames to join
dfs_to_join <- list(basic_demographics, pivoted_med_first_day, labs_first_day, vitals_first_day, icu_mortality_72hrs,apachescore, apacheadmission, er_los)
